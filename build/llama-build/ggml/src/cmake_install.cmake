# Install script for directory: /root/activeFlow/llama.cpp/ggml/src
...
if(NOT CMAKE_INSTALL_LOCAL_ONLY)
  ...
  include("/root/activeFlow/measure_loading_speed/measuring_speed/build/llama-build/ggml/src/ggml-cpu/cmake_install.cmake")
endif()
...
if(CMAKE_INSTALL_COMPONENT STREQUAL "Unspecified" OR NOT CMAKE_INSTALL_COMPONENT)
  ...
  file(INSTALL DESTINATION "${CMAKE_INSTALL_PREFIX}/lib" TYPE SHARED_LIBRARY FILES "/root/activeFlow/measure_loading_speed/measuring_speed/build/bin/libggml-cpu.so")
  if(EXISTS "$ENV{DESTDIR}${CMAKE_INSTALL_PREFIX}/lib/libggml-cpu.so" AND
     NOT IS_SYMLINK "$ENV{DESTDIR}${CMAKE_INSTALL_PREFIX}/lib/libggml-cpu.so")
    file(RPATH_CHANGE
         FILE "$ENV{DESTDIR}${CMAKE_INSTALL_PREFIX}/lib/libggml-cpu.so"
